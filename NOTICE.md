...
- `NOTICE.md`: this file.
- `.github/workflows/`: upstream Gitea CI and cron workflows removed, because they need Gitea's runners and secrets. Thally Track watches this repository through the Thally Cloud GitHub App.
